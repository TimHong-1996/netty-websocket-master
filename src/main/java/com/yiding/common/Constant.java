...
public class Constant {
	...
	public static Map<String, ChannelHandlerContext> onlineAdviserMap =
	        new ConcurrentHashMap<String, ChannelHandlerContext>();

	public static Map<String, ChannelHandlerContext> onlineManagerMap =
			new ConcurrentHashMap<String, ChannelHandlerContext>();

	public static Map<String, ChannelHandlerContext> onlineVisitorMap =
			new ConcurrentHashMap<String, ChannelHandlerContext>();

	public static Map<String, VisitorDto> visitorInfoMap =
	        new HashMap<String, VisitorDto>();

	public static Map<String, Map<String,VisitorDto>> adviserToVisitorListMap =
			new HashMap<String, Map<String,VisitorDto>>();
	
	public static Map<String, ManagerDto> adviserInfoMap =
	        new HashMap<String, ManagerDto>();

	public static Map<String, ManagerDto> managerInfoMap =
			new HashMap<String, ManagerDto>();
}
